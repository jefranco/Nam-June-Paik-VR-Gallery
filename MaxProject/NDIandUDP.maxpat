...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 245.0, 457.0, 50.0, 22.0 ],
					"text" : "36.83"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 163.0, 414.0, 50.0, 22.0 ],
					"text" : "11.9"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 77.0, 389.0, 127.0, 22.0 ],
					"text" : "/unity"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 5,
					"outlettype" : [ "", "", "", "", "" ],
					"patching_rect" : [ 185.0, 337.0, 61.0, 22.0 ],
					"text" : "unjoin 4"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 185.0, 211.0, 50.0, 64.0 ],
					"text" : "/unity 79.69 11.9 36.83"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 178.0, 162.0, 97.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 686.0, 378.0, 143.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 346.0, 234.0, 208.0, 130.0 ],
					"prototypename" : "pixl",
					"varname" : "brcosr",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"offset" : [ 0.0, 0.0 ],
					"patching_rect" : [ 313.0, 415.0, 230.0, 208.0 ],
					"prototypename" : "pixl",
					"varname" : "viewr",
					"viewvisibility" : 1
				}
...
,
					...
					"output_texture" : 0,
					"parameter_enable" : 0,
					"patching_rect" : [ 642.0, 277.0, 150.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 626.0, 444.0, 73.0, 22.0 ],
					"text" : "jit.ndi.send~"
				}
